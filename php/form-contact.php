...
if(isset($_POST['email'])) {
    ...
    $email_to = "contato@lorenabarbosacavalcanti.com";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.lorenabarbosacavalcanti.com/');</script>";
